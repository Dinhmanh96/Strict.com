<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO message(name, email, message, subscribe , time_cmt)VALUES('$name','$email','$message', '$subscribe', '$time_cmt')";
                ...
                ?>
                    <div class="col-sm-12 col-sm-6 col-md-4 pic">
                        <span style="display: none;" class="title">
                            <?php echo $rows_showcase['name_project'];?>
                        </span>
                        <span style="display: none;" class="description">
                            <?php echo $rows_showcase['description'];?>
                        </span>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <span class="description-modal"></span>
                    </div>
                    <div class="modal-footer">
                        Link project: <a href="" class="modal-link"></a>
                    </div>
                </div>
            </div>
        </div>
